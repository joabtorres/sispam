                    ...
                    <article class="card-body">
                        <div class="form-row">
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" name="nData"  class="form-control date_serach inpu-data" id="iData" placeholder="Exemplo: dd/mm/aaaa" value="<?php echo!empty($arrayCad['protocolo']['data_protocolo']) ? $this->formatDateView($arrayCad['protocolo']['data_protocolo']) : ''; ?>" required>
