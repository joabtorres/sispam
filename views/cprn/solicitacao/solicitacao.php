<div class="container-fluid">
        ...
        <div class="col" id="pagina-header">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><a href="<?php echo BASE_URL ?>cprn/solicitacao/<?php echo md5($result['id']); ?>">Solicitação: Nº <?php echo str_pad($result['id'], 5, '0', STR_PAD_LEFT) ?> </a></li>
                </ol>
            </nav>
        </div>
        <!--fim pagina-header;-->
    ...
    <div class="row">
        <div class="col">
            <div class="row">
                <div class="col">
                    <a class="btn btn-primary btn-sm pull-right" href="<?php echo BASE_URL . 'cprn/editar/' . md5($result['id']); ?>" title="Editar"><i class="fa fa-pencil-alt"></i> Editar</a>  
                </div>
            </div>
                ...
                <div class="collapse show" id="collapseExampleProtocolo">
                    <article class="card-body py-0">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <p class="text-justify"><div class="text-success font-bold">Data de recebimento:</div> 
                                <?php echo (isset($result) && !empty($result['data_recebimento'])) ? $this->formatDateView($result['data_recebimento']) : ''; ?>
                                </p>
                            </div>
                ...
                <div class="collapse show" id="collapseExampleDenuncia">
                    <article class="card-body py-0">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <p class="text-justify"><div class="text-success font-bold">Categoria:</div> 
                                <?php echo (isset($result) && !empty($result['categoria'])) ? $result['categoria'] : ''; ?>     
                                </p>
                            </div>
                            <div class="col-md-3">
                                <p class="text-justify"><div class="text-success font-bold">Tipo da solicitação:</div> 
                                <?php echo (isset($result) && !empty($result['acao'])) ? $result['acao'] : ''; ?>     
                                </p>
                            </div>
                            <div class="col-md-3">
            ...
            <section class="modal fade" id="modal_vistoria_<?php echo md5($indice['id']) ?>" tabindex="-1" role="dialog">
                <article class="modal-dialog modal-md modal-dialog-centered" role="document">
                    <section class="modal-content">
                        ...
                        <footer class="modal-footer">
                            <a class="btn btn-danger pull-left" href="<?php echo BASE_URL . 'cprn/excluirvistoria/' . md5($indice['id']) ?>"> <i class="fa fa-trash"></i> Excluir</a> 
                            <button class="btn btn-default" type="button" data-dismiss="modal"><i class="fa fa-times"></i> Fechar</button>
                        </footer>
                    </section>
                </article>
            ...
            <section class="modal fade" id="modal_anexoexcluir_<?php echo md5($indice['id']) ?>" tabindex="-1" role="dialog">
                <article class="modal-dialog modal-lg modal-dialog-centered" role="document">
                    <section class="modal-content">
                        ...
                        <footer class="modal-footer">
                            <a class="btn btn-danger pull-left" href="<?php echo BASE_URL . 'cprn/excluiranexo/' . md5($indice['id']) ?>"> <i class="fa fa-trash"></i> Excluir</a> 
                            <button class="btn btn-default" type="button" data-dismiss="modal"><i class="fa fa-times"></i> Fechar</button>
                        </footer>
                    </section>
                </article>
            ...
            <section class="modal fade" id="modal_historico_<?php echo md5($indice['id']) ?>" tabindex="-1" role="dialog">
                <article class="modal-dialog modal-md modal-dialog-centered" role="document">
                    <section class="modal-content">
                        ...
                        <footer class="modal-footer">
                            <a class="btn btn-danger pull-left" href="<?php echo BASE_URL . 'cprn/excluirhistorico/' . md5($indice['id']) ?>"> <i class="fa fa-trash"></i> Excluir</a> 
                            <button class="btn btn-default" type="button" data-dismiss="modal"><i class="fa fa-times"></i> Fechar</button>
                        </footer>
                    </section>
                </article>
