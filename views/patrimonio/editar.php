<div class="container-fluid">
        ...
        <div class="col" id="pagina-header">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item" ><a href="<?php echo BASE_URL ?>patrimonio/consultar/1"><i class="fas fa-tasks"></i> Consultar Patrimônios</a></li>     
                    <li class="breadcrumb-item" ><a href="<?php echo BASE_URL ?>patrimonio/patrimonio/<?php echo md5($patrimonio['id']); ?>">Patrimônio: Nº <?php echo str_pad($patrimonio['id'], 5, '0', STR_PAD_LEFT) ?> </a></li>
                    <li class="breadcrumb-item active" aria-current="page"><a href="<?php echo BASE_URL ?>patrimonio/editar/<?php echo!empty($patrimonio['id']) ? $patrimonio['id'] : 0; ?>"><i class="fas fa-edit"></i>  Editar Patrimônio</a></li>
                </ol>
            </nav>
        </div>
        <!--fim pagina-header;-->
    ...
    <div class="row">
        <div class="col">
            <form method="POST" action="<?php echo BASE_URL ?>patrimonio/editar/<?php echo!empty($patrimonio['id']) ? md5($patrimonio['id']) : 0; ?>" enctype="multipart/form-data" autocomplete="off"  name="nFormPatrimonio">
                ...
                <section class="card bg-light border-secondary">
                    <header class="card-header bg-dark text-while">
                        <h1 class="card-title h5 my-1"><i class="fas fa-edit"></i>  Editar Patrimônio</h1>
                    </header>
